...
export async function getPartiesByIds(partyIds: string[]) {
	...
	return sql<{ id: string; name: string | null; shortName: string | null; seats: string | null; activeFrom: Date | null; activeTo: Date | null; contentType: string | null; logoData: unknown | null; createdAt: Date | null; updatedAt: Date | null }>`
        SELECT
            id,
            naam_nl as name,
